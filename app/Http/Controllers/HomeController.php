...
class HomeController extends Controller
{
    ...
    public function redirect()
    {
        ...
        if($usertype == '1')
        {
            ...
            return view('admin.home', compact('total_product','total_order','total_user','total_revenue','order_processing','order_delivered','order_delivered'));
        }
    ...
    public function add_cart(Request $request, $id)
    {
        if(Auth::id())
        {
            ...
            $userid=$user->id;
            $product=product::find($id);
            $product_exist_id=cart::where('product_id','=',$id)->where('nuser_id', '=', $userid)->get('id')->first();
            $cart=new cart;
    ...
    public function show_order()
    {
        if(Auth::id())
        {
            ...
            $order=order::where('nuser_id', '=' ,$userid)->get();
